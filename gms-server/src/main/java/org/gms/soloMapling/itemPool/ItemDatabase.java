...
import org.gms.soloMapling.server.MapleVersionManager;

import static org.gms.soloMapling.server.MapleVersionManager.getItemPoolVersion;
import static org.gms.soloMapling.itemPool.ItemDatabase.loadItemDatabase;
import static org.gms.soloMapling.itemPool.ItemSelector.toInteger;
...
public class ItemDatabase {
    ...
    public static void loadItemDatabase() throws Exception {
        ...
        for (String itemPool : itemPools) {
            String yamlFile = "soloMapling/itemPool/itemConfig/" + itemPool;
