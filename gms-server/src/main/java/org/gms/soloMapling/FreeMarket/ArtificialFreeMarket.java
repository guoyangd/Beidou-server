package org.gms.soloMapling.FreeMarket;
...
import static org.gms.soloMapling.ArtificialPlayer.BotCustomization.getRandomStorePermitId;
...
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.MovementCommands.microTurnAround;
import static org.gms.soloMapling.DebugUtilities.debugprint;
import static org.gms.soloMapling.FreeMarket.ArtificialShopGenerator.applyAdditionalShopMods;
import static org.gms.soloMapling.FreeMarket.ArtificialShopGenerator.applyCheapSaleDiscount;
import static org.gms.soloMapling.FreeMarket.ArtificialShopGenerator.applyQuittingSaleDiscount;
import static org.gms.soloMapling.FreeMarket.ArtificialShopGenerator.buyoutSomeItems;
import static org.gms.soloMapling.FreeMarket.ArtificialShopGenerator.setOneMesoShop;
import static org.gms.soloMapling.FreeMarket.ArtificialShopGenerator.generateShop;
import static org.gms.soloMapling.FreeMarket.ArtificialShopGenerator.generateSecondaryShop;

import static org.gms.soloMapling.FreeMarket.FMEconomyManager.getTierForRoom;
import static org.gms.soloMapling.FreeMarket.FMEconomyManager.isHotRoom;
import static org.gms.soloMapling.FreeMarket.FMShopTypeManager.selectHotRoomShopType;
import static org.gms.soloMapling.FreeMarket.FMShopDescriptionManager.appendRoomNumber;
import static org.gms.soloMapling.FreeMarket.FMShopDescGen.getRandomShopOwnerIGN;
import static org.gms.soloMapling.FreeMarket.FMShopDescriptionManager.setMerchantDescription;
import static org.gms.soloMapling.FreeMarket.FMShopDescriptionManager.appendMerchantDescription;
import static org.gms.soloMapling.FreeMarket.FMShopInfoManager.getRegionByMapId;
import static org.gms.soloMapling.FreeMarket.FMShopTypeManager.getSecondaryShopItemTypes;
import static org.gms.soloMapling.FreeMarket.FMShopTypeManager.selectShopTypeWeightedProbability;

import static org.gms.soloMapling.FreeMarket.HiredMerchantArtificial.shopTypes.*;
import static org.gms.soloMapling.server.ExecutorServiceManager.getExecutorService;
import static org.gms.soloMapling.server.ExecutorServiceManager.getScheduledExecutorService;
import static org.gms.soloMapling.server.SoloMaplingUtilities.chance;
...
public class ArtificialFreeMarket {
    ...
    public static void populateFreeMarketRegion(String region) {
        ...
        // BeiDou: 场景 Bot 减半——FM 房间商人按 50% 随机抽房（空房间视觉上同样成立）。
