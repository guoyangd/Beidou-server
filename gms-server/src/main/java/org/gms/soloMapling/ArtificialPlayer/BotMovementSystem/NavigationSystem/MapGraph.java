package org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.NavigationSystem;
...
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.InPacketReader.getMovementRecordingRaw;
...
public class MapGraph {
    ...
    public MapGraph(int mapId) {
        ...
        this.directory = new File("soloMapling/ArtificialPlayer/BotMovementSystem/movementDataPackets/map" + this.mapId);
        this.setMainAreas();
        this.setConnectors();
        this.buildGraph();
    }
