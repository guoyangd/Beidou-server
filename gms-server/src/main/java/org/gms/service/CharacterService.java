    ...
    public Page<ChrOnlineListRtnDTO> getChrOnlineList(ChrOnlineListReqDTO request) {
        ...
        return BasePageUtil.create(chrList, request)
                ...
                .page(chr -> ChrOnlineListRtnDTO.builder()
                        ...
                        .mapName(org.gms.server.maps.MapFactory.loadPlaceName(chr.getMap().getId()))
                        .streetName(org.gms.server.maps.MapFactory.loadStreetName(chr.getMap().getId()))
                        .mapName(chr.getMap().getMapName() != null ? chr.getMap().getMapName() : "")
